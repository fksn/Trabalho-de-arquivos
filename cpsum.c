...
int main(int argc, char * argv[])
{
    ...
    if (argc != 4)
    {
        printf("Modelo de uso: ./cpsum <file_name_1> <file_name_2> <file_name_out>\n");
        return 0;
    }
    ...
    Num[2].real = Num[0].real + Num[1].real;
    Num[2].img = Num[0].img + Num[1].img;
    // printf("%s %lf %lf\n", Num[2].code, Num[2].real, Num[2].img);
