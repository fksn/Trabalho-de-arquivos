...
int main(int argc, char * argv[])
{
    ...
    Num[2].real = (Num[0].real * Num[1].real + Num[0].img * Num[1].img) / (Num[1].real*Num[1].real + Num[1].img*Num[1].img);
    Num[2].img = (Num[0].img *  Num[1].real - Num[0].real * Num[1].img) / (Num[1].real*Num[1].real + Num[1].img*Num[1].img);
